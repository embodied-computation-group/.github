...
**[the-ecg.org](https://www.the-ecg.org)** · **[Publications](https://scholar.google.com/citations?user=C49AeHAAAAAJ&hl=en)**
...
|:--------|:------------|:--------|
| **[systole](https://github.com/embodied-computation-group/systole)** | Cardiac signal processing, HRV analysis, artifact correction, and real-time peak detection | `pip install systole` |
| **[Cardioception](https://github.com/embodied-computation-group/Cardioception)** | Psychophysical tasks for measuring cardiac interoception (heartbeat counting & heart rate discrimination) | `pip install cardioception` |
...
**PI: [Micah Allen](https://www.the-ecg.org/team)** · micah@cfin.au.dk · [@the-ecg.org](https://bsky.app/profile/the-ecg.org)

We're always looking for collaborators, visiting scholars, and new team members — [get in touch](https://www.the-ecg.org/joinus).
